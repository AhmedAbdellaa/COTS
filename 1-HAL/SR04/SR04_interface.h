...
/// @brief get time of trigger bin o ultrasonic timer1 and icu should be initialize before call it and set prescaler to 1024 or change the tick time
/// @param ref_trigger pin to rigger signal
